...
// Artigos adicionais (ex-blogDataPart1)
export const blogPostsPart1 = [
{
    id: 1,
...
// Exportar todos os posts combinados (15 + 4 + 63 = 82 artigos)
import { blogPostsDocx } from './blogPostsDocx';
export const allBlogPosts = [...blogPosts, ...blogPostsExtra, ...blogPostsPart1, ...blogPostsDocx];
